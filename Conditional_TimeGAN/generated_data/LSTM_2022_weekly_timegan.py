...
data_load_path = '/home/langleman/Conditional_TimeGAN/data/marimonte_weekly_new.csv'
category_list = ['JK', 'JP', 'BL','VT','SL','SK','OP','TC','CT','KT','KC','TS','PD']
plot_save_path = '/home/langleman/Conditional_TimeGAN/result/iter6000/figures1121'
csv_save_path = '/home/langleman/Conditional_TimeGAN/result/iter6000/LSTM_2022_weekly_iter6000_1121.csv'
...
def category_data_multi3(data, cate, sequence_length, lag):
    ...
    df = pd.read_csv(f'/home/langleman/Conditional_TimeGAN/generated_data/data4inference/padded_weekly_{cate}_1121_all.csv')
...
def train_and_plot(data, i, test_size = 12, sequence_length = 12, lag = 1, input_size = 6, hidden_size = 64, num_layers = 1,
    ...
    model_save_path = '/home/langleman/Conditional_TimeGAN/result/iter6000/model/{}_lag{}_total1/'.format(i, lag)
